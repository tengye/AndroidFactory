...
//RE.setFontName = function(){
//    document.execCommand('fontName', false, 'Arial');
//}

//RE.setFontSize2 = function(){
//    document.execCommand("fontSize", false, 2);
//}
//
//RE.setFontSize3 = function(){
//    document.execCommand("fontSize", false, 3);
//}
//
//RE.setFontSize5 = function(){
...
RE.enabledEditingItems = function(e) {
    ...
    if (document.queryCommandValue('fontSize')) {
        ...
        if(size == 2){
            items.push("fontSizeSmall");
        }

        if(size == 3 || size == 4){
            items.push("fontSizeMedium");
        }

        if(size > 4){
            items.push("fontSizeLarge");
        }
